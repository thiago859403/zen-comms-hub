...
import { Bot, Plus, Edit, Trash2, Loader2, AlertTriangle, CheckCircle2, XCircle } from "lucide-react";
            ...
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
              ...
              <div className="space-y-4 py-4">
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-muted-foreground">
                    Defina o comportamento, personalidade e contexto do agente. Este será o system prompt usado nas conversas.
                  </p>
                </div>
                <div className="space-y-2">
                          ...
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  Tem certeza que deseja remover o agente "{agente.nome}"? Esta ação não pode ser desfeita.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
